    ...
    class TextRendering : GameWindow
    {
        ...
        public class TextRenderer : IDisposable
        {
            ...
            public void DrawString(string text, TextRenderingOptions options = null)
            {
                ...
                dirty_region = Rectangle.Round(RectangleF.Union(dirty_region, new RectangleF(options.Location, size)));
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            TextRenderingOptions opt = new TextRenderingOptions();
            opt.Location = new PointF(50, 50);
            opt.Alignment = new TextAlignment(AlignmentHorizontal.ALIGN_CENTER, AlignmentVertical.ALIGN_CENTER);
            renderer.DrawString("Test", opt);
        }
